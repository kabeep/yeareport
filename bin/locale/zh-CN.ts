export default {
    ...
    CMD_DES_OPTION_OUTPUT: '输出目录，相对于当前工作目录，默认 `User/Downloads`',
    CMD_DES_OPTION_REVERSE: '日志按时间正序输出',
    CMD_DES_OPTION_APPEND_TYPE: '自定义提交类型',
    CMD_DES_OPTION_OVERWRITE: '覆写授权，当前工作目录已存在时进行覆写操作',
    CMD_DES_OPTION_PRETTY: '美化标题，使用 emoji 美化 Markdown 标题',
